...
class CNN(nn.Module):
    def __init__(self, height: int, width: int, channels: int, batch_size: int):
        ...
        self.batch2d2 = nn.BatchNorm2d(64)
        ...
        self.batch2d3 = nn.BatchNorm2d(128)
...
class Trainer:
    ...
    def evaluate(self):
        ...
        pkl.dump(preds, open("preds-batchnorm.pkl", "wb"))
        pkl.dump(dataset, open("gts-batchnorm.pkl", "wb"))
...
def get_summary_writer_log_dir(args: argparse.Namespace) -> str:
    tb_log_dir_prefix = f'CNN Pan et al with Batchnorm--'
    i = 0
    while i < 1000:
